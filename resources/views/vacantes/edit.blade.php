...
<head>
    ...
    <title>Editar Vacante - Bolsa Trabajo ITSZN</title>
...
<body class="bg-gray-100">
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">✏️ Editar Vacante</h1>
                    ...
                    <span class="inline-block px-2 py-1 text-xs rounded 
                        ...
                        Estado: {{ ucfirst($vacante->estado) }}
                    </span>
                </div>
                <div class="space-x-4">
                    <a href="{{ route('vacantes.index') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{ route('vacantes.update', $vacante) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="descripcion" rows="4"
                                      ...
                                      required>{{ old('descripcion', $vacante->descripcion) }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="requisitos" rows="4"
                                      ...
                                      required>{{ old('requisitos', $vacante->requisitos) }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="beneficios" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                      placeholder="Seguro médico, prestaciones, bonos, etc.">{{ old('beneficios', $vacante->beneficios) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="tipo_contrato" 
                                ...
                                <option value="practicas" {{ old('tipo_contrato', $vacante->tipo_contrato) == 'practicas' ? 'selected' : '' }}>Prácticas Profesionales</option>
                                <option value="freelance" {{ old('tipo_contrato', $vacante->tipo_contrato) == 'freelance' ? 'selected' : '' }}>Freelance</option>
                                <option value="proyecto" {{ old('tipo_contrato', $vacante->tipo_contrato) == 'proyecto' ? 'selected' : '' }}>Por Proyecto</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="nivel_experiencia" 
                                    ...
                                    required>
                                <option value="">Seleccionar...</option>
                                <option value="sin_experiencia" {{ old('nivel_experiencia', $vacante->nivel_experiencia) == 'sin_experiencia' ? 'selected' : '' }}>Sin experiencia</option>
                                <option value="junior" {{ old('nivel_experiencia', $vacante->nivel_experiencia) == 'junior' ? 'selected' : '' }}>Junior (0-2 años)</option>
                                <option value="mid" {{ old('nivel_experiencia', $vacante->nivel_experiencia) == 'mid' ? 'selected' : '' }}>Mid-level (2-5 años)</option>
                                <option value="senior" {{ old('nivel_experiencia', $vacante->nivel_experiencia) == 'senior' ? 'selected' : '' }}>Senior (5+ años)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="vacantes_disponibles" value="{{ old('vacantes_disponibles', $vacante->vacantes_disponibles) }}" min="1"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_limite" value="{{ old('fecha_limite', $vacante->fecha_limite->format('Y-m-d')) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   min="{{ date('Y-m-d') }}"
                                   required>
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="salario_min" value="{{ old('salario_min', $vacante->salario_min) }}" step="0.01" min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   placeholder="0.00">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="salario_max" value="{{ old('salario_max', $vacante->salario_max) }}" step="0.01" min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   placeholder="0.00">
                        </div>
                        ...
                        <div class="flex items-end">
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="salario_mostrar" value="1" 
                                       {{ old('salario_mostrar', $vacante->salario_mostrar) ? 'checked' : '' }}
            ...
            <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <h3 class="font-semibold text-yellow-800 mb-2">📌 Información importante</h3>
                <ul class="text-yellow-700 text-sm list-disc list-inside space-y-1">
                    <li>Al editar una vacante, su estado cambiará a "pendiente" y requerirá nueva aprobación del administrador</li>
                    <li>Recibirás una notificación cuando tu vacante sea aprobada nuevamente</li>
                    <li>Si la vacante estaba aprobada, dejará de estar visible para los alumnos hasta que sea re-aprobada</li>
                </ul>
            </div>
        </div>
    </div>
