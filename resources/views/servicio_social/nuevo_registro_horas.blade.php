...
<head>
    ...
    <title>Nuevo Registro de Horas - Servicio Social ITSZN</title>
...
<body class="bg-gray-100">
    ...
    <header class="header-institucional shadow-sm">
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold">➕ Nuevo Registro de Horas</h1>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 mb-6 fade-in">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 fade-in">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-xl font-semibold texto-azul-itszn">Formulario de Registro</h2>
                </div>
    ...
    <script>
        ...
        function updateProgress() {
            ...
            // Podrías mostrar esto visualmente si quisieras
